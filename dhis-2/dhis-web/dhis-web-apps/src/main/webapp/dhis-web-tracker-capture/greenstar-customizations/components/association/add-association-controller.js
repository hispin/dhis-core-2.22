...
//Controller for settings page
    ...
    function($rootScope,
        ...
        $scope.firstRun = true;
        $scope.eventToReturn = $modalInstance.selectedEvent;
        ...
        $timeout(function(){
            $scope.updateEventTeiMap($scope.eventToReturn);
        })
        ...
        $scope.close = function () {
            $timeout(function() {
                ...
                $rootScope.$broadcast('association-widget', {event : $scope.eventToReturn , show :true});
            }, 200);
            $modalInstance.close();
        };
        ...
        function areMultipleAssociationAllowed(prstUID){
            ProgramStageFactory.get(prstUID).then(function(prst){
                var value = utilityService.extractMetaAttributeValue(prst.attributeValues,"areMultipleAssociationAllowed");
                if (value == "true"){
                    return true;
                }
                return false;
